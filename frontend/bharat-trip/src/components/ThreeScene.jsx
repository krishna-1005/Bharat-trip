...
function ImageCard({ url, position, rotation, scale = 1 }) {
  ...
  useFrame((state) => {
    ...
    // Using performance.now() as a source for time to avoid Clock deprecation and Fiber state issues
    ...
    <div style={{
      ...
      <Canvas 
        ...
        gl={{ 
          ...
          powerPreference: "low-power" // Prefer low power to avoid context kills
        }}
      >
