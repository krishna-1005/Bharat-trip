...
const CollabSidebar = ({ trip, onlineUsers, polls, setActiveTab }: any) => {
  ...
  return (
    <div style={{ width: '280px', borderLeft: `1px solid ${COLORS.border}`, display: 'flex', flexDirection: 'column', backgroundColor: COLORS.cardBg, overflowY: 'auto' }}>
          ...
          {messages.map((msg, idx) => {
            ...
            return (
                <div key={idx} style={{ marginBottom: '4px' }}>
                    <div style={{ fontSize: '11px', color: COLORS.accent, fontWeight: 'bold', marginBottom: '4px' }}>
                        {isMe ? 'You' : msg.senderName} <span style={{ color: COLORS.textMuted, fontWeight: 'normal' }}>• 2m ago</span>
                    </div>
                    <div style={{ 
