...
const TravelFeed = () => {
  ...
  const trending = [
    { id: 2001, title: "Golden Triangle Luxury", city: "Delhi, Jaipur", days: 5, cost: 42000, tags: ["History", "Royal"], img: "https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=800" },
    { id: 2002, title: "Kerala Backwater Bliss", city: "Alleppey", days: 4, cost: 22000, tags: ["Nature", "Relaxed"], img: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?q=80&w=800" },
    { id: 2003, title: "Goa Beach Party", city: "North Goa", days: 3, cost: 15000, tags: ["Party", "Beach"], img: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?q=80&w=800" }
  ];

  const ideas = [
    { id: 2004, title: "Spirituality in Kashi", city: "Varanasi", days: 3, cost: 12000, tags: ["Culture", "Spiritual"], img: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?q=80&w=800" },
    { id: 2005, title: "Yoga Retreat", city: "Rishikesh", days: 5, cost: 18000, tags: ["Wellness", "Adventure"], img: "https://images.unsplash.com/photo-1545105511-923f63f29e07?q=80&w=800" }
  ];
